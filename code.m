...
%% Sampling Frequency
Fs = 250; %[Hz], perciò il segnale è misurato per 2 secondi
...
%Changing the labels
label_tuab(label_tuab == 0) = 3; %pongo abnormal = 3
label_tuar(label_tuar == 0) = 2; %pongo artefact = 2
